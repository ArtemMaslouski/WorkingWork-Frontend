        ...
        <div className="find_help_component">
            ...
            <div className="action_button">
                <Button   
                    ...
                    style={{ backgroundColor: 'rgba(215, 201, 164)',fontWeight:'light', color: 'black', border: '2px solid #625430', height:'5vh', fontSize:'1rem' }} 
                />
                <Button
                    text="Стать исполнителем" 
                    onClick={handleClickFind}
                    style={{ backgroundColor: 'white',fontWeight:'light', color: 'black', border: '2px solid #625430',height:'5vh', fontSize:'1rem '}} />
            </div>
        </div>
    </div>
  )
