...
const Header = () => {
    ...
    return (
        <div className='header_component'>
                ...
                <nav className="nav">
                    <div className="logo_and_menu">
                        ...
                        <ul className="desktop_links">
                            ...
                            <NavLink to='/FindTask' className={({ isActive }) => isActive ? 'findExercise active' : 'findExercise'}>
                            {t('findTask')}
                            </NavLink>
                        </ul>
                    </div>
            ...
            <LanguageModal isOpen={isWorldModalOpen} onClose={() => setIsWorldModalOpen(false)} />
        </div>
    );
}
