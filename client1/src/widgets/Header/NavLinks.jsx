  ...
  return (
    <>
       <NavLink to='/CreatingTask' className={({ isActive }) => 
        ...
        <NavLink to='/FindTask' className={({ isActive }) => isActive ? 'findExercise active' : 'findExercise'}>{t('findTask')}</NavLink>
      ...
      {isAuthenticated ? (
        ...
        <NavLink to='/SignIn' className={({ isActive }) => isActive ? 'active' : ''}>{t('login')}</NavLink>
      )}
    </>
  );
};
