...
export const handleLogout = (navigate, t, logout) => {
  Swal.fire({
...
export const handleVerificateUserWithCodeFromEmail = async (
  Code,
  setCode,
  Email,
  setEmail,
  ...
  try {
    const isVerified = await userApi.verificateUserWithCodeFromEmail(
      Code,
      Email
    );
